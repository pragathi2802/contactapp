...
function viewData() {
    ...
    for(var i = 0; i < contacts.length; i++){
        ...
        data += "<td> <button onclick = editContact(" + i + ")><img src='images/image1.jpg'></button>";
        data += "<td> <button onclick = deleteContact(" + i +")><img src='images/image3.png'></button>";
...
var cname=document.getElementById("cname").value;
    ...
    contact = {
        "name":cname, "email":email, "mobile":mobile 
    };
    return contact;
